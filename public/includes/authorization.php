<div class="card">
	<div class="card-header" id="headingOne">
        <h5 class="mb-0">
            <button class="btn btn-link" data-toggle="collapse" data-target="#authorizationPanel" aria-expanded="true" aria-controls="collapseOne">
              A U T H O R I Z A T I O N
    	 	</button>
    	</h5>
    </div>
    <div class="container-fluid my-2 py-2 collapse signature-component " id="authorizationPanel">
    	<div class="row">
    		<div class="col-lg">
        		<blockquote class="blockquote">
                  <p class="mb-1">I request that payment of authorized Medicare, Medicaid, or 
