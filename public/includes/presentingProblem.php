		<div class="card">
			...
			<div class="container-fluid my-2 py-2 collapse" id="problemPanel" >
				...
				<div id="mapRow" class="row my-2">
					<div class="col">
						<script>
						//Initialize Imapster for pain map $('#painMap').mapster();
						...
						<div class="form-group" id="thoraxMapList" style="position:absolute; z-index:10; left:12px; top:50px; width:400px;background-color:black; border:1px solid #464f5a; display:none;">
    						...
    						<select size="19" id="thoraxMapListBox" onchange="checkMap(thoraxMapListBox, traumaMapItems, selectThorax)" class="form-control form-control-sm">
    							<option value="2ND DEGREE BURN NOS">2ND DEGREE BURN NOS</option>
            					<option value="3RD DEGREE BURN NOS">3RD DEGREE BURN NOS</option>
					...
					<map name="painMap1">
						<area  class="headArea"  shape="circle" coords="115,42,31" onclick="boxShow('headMapList')"  alt="Head">
						<area href="javascript:boxShow('neckMapList')" class="neckArea"  shape="rect" coords="98,79,133,99" onclick="boxShow('neckMapList')"  alt="Neck">
						<area onclick="boxShow('thoraxMapList')" class="thorax" shape="poly" coords="70,104,96,93,114,99,132,91,159,101,153,155,84,153" href="" alt="Thorax" >
