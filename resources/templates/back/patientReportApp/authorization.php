<div class="card">
    ...
    <div class="container-fluid my-2 py-2 collapse " id="authorizationPanel">
    	...
    	<div class="container-fluid my-4 border border-light">
   		...
   		<input type="text" id="signSec1" name="signSec1">
    	<input type="text" id="signSec2" name="signSec2">
    	<input type="text" id="signSec3" name="signSec3">
    	<input type="text" id="signSec4" name="signSec4">
    	<input type="text" id="signSec5" name="signSec5">
