	...
	<div class="container-fluid my-2 py-2 collapse show" id="dispatchPanel" >
		...
		<div class="form-row">
			<div class="form-group col-sm">
				...
				<input required onclick="getDate(dispatchDate)" name="dispatchDate" id="dispatchDate" type="text" class="form-control" placeholder="MM/DD/YYYY" value="<?php echo $dispatchDate?>"></input>
			</div>
			<div class="col-sm">
				<label>Run Id: </label>
				<input onclick="getRunId(dispatchDate)"type="text" class="form-control" name="runId" id="runId" value="<?php echo $runId?>">
			</div>
			<div class="col-sm">
				<label>Veh. Id: </label>
		...
		<div class="form-row">
			<div class="form-group col-sm">
				...
				<input readonly text="text" class="form-control" name="dispatchAgency" id="dispatchAgency" value="<?php echo $agencyName?>">
			</div>
			<div class="form-group col-sm">
		...
		<div class="form-row mb-2">
			<div class="form-control col">
				...
				<input type="text" onclick="getClock(timeReceived)" name="timeReceived" id="timeReceived" readonly type="text" value="<?php echo $timeReceived ?>"></input>
			</div>
			<div class="form-control col">
				<label>On Route</label>
				<input type="text" onclick="getClock(timeRoute)" type="text" readonly name="timeRoute" value="<?php echo $timeRoute ?>"></input>
			</div>
			<div class="form-control col">
				<label>At Scene</label>
				<input type="text" onclick="getClock(timeAtScene)" type="text" name="timeAtScene" readonly id="timeAtScene" value="<?php echo $timeAtScene ?>"></input>
			</div>
			<div class="form-control col">
				<label>From Scene</label>
				<input type="text" onclick="getClock(timeFromScene)" type="text" readonly name="timeFromScene" id="timeFromScene" value="<?php echo $timeFromScene?>"></input>
			</div>
			<div class="form-control col">
				<label>At Destination</label>
				<input type="text" onclick="getClock(timeAtDes)" type="text" readonly name="timeAtDes" id="timeAtDes" value="<?php echo $timeAtDes?>"></input>
			</div>
			<div class="form-control col">
				<label>In Service</label>
				<input onclick="getClock(timeInService)" type="text" readonly name="timeInService" id="timeInService" value="<?php echo $timeInService?>"></input>
			</div>
			<div class="form-control col">
				<label>In Quarter</label>
				<input onclick="getClock(timeInQuarter)" type="text" readonly name="timeInQuarter" id="timeInQuarter" value="<?php echo $timeInQuarter ?>"></input>
			</div>
		</div>
